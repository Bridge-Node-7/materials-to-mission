...
Current supply-policy context is maintained separately in [Current State](docs/CURRENT_STATE.md) so new public facts do not silently rewrite the GA-001 v1.0.0 review basis.
